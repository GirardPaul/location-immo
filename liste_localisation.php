...
<?php
    ...
    echo "<h1 class='mt-10 text-center'>Liste des Communes :</h1>";
    echo "<table class='table mt-5'>";
    echo "<thead>
    <tr>
      <th scope='col'>#Ville <span id='span' class='fas fa-arrow-down'></span></th>
      <th scope='col'>#Habitants <span id='span1' class='fas fa-arrow-down'></span></th>
      <th scope='col'>#Distance de l'agence <span id='span2' class='fas fa-arrow-down'></span></th>
    ...
    while ($list=$req->fetch()){
         ...
         echo "<tr><td>".$list['nom']."</td><td>".$list['habitants']."</td><td>".$list['distance']."</td><td><a class='film-suppr badge badge-danger' href=suppression_commune.php?listcom=".$list['id'].">Supprimer</a>"."</td></tr>";
    ...
    $sql_q="SELECT * FROM quartier";
    $req_q = $bdd->query($sql_q);

    echo "<form class='d-flex justify-content-center flex-column md-form' action='' method='post'>";
    echo "<h1 class='mt-10 text-center'>Liste des Quartiers :</h1>";
    echo "<table class='table mt-5'>";
    echo "<thead>
    <tr>
      <th scope='col'>#Nom</th>
    ...
    echo "<tbody>";
    while ($list_q=$req_q->fetch()){

         echo "<tr><td>".$list_q['nom']."</td><td>"."<a class='film-suppr badge badge-danger' href=suppression_quartier.php?listqua=".$list_q['id'].">Supprimer</a>"."</td></td>";
