...
<?php
    ...
    $sql="SELECT l.id as lid, c.nom as cnom, q.nom as qnom, superficie, adresse, t.nom as tnom, loyer, charge
    FROM logement l
    JOIN quartier q
    ...
    echo "<h1 class='mt-10 text-center'>Liste des Logements :</h1>";
    echo "<table class='table mt-5'>";
    echo "<thead>
    <tr>
      <th scope='col'>#Ville/Quartier <span id='span' class='fas fa-arrow-down'></span></th>
      <th scope='col'>#Adresse</th>
      <th scope='col'>#Superficie <span id='span1' class='fas fa-arrow-down'></span></th>
      <th scope='col'>#Type <span id='span2' class='fas fa-arrow-down'></span></th>
      <th scope='col'>#Loyer <span id='span3' class='fas fa-arrow-down'></span></th>
      <th scope='col'>#Charges <span id='span4' class='fas fa-arrow-down'></span></th>
    ...
    while ($list=$req->fetch()){
        ...
        echo "<tr><td>".$list['cnom'].'/'.$list['qnom']."</td><td>".$list['adresse']."</td><td>".$list['superficie']."</td><td>".$list['tnom']."</td><td>".$list['loyer']."</td><td>".$list['charge']."</td><td>"."<a class='film-modif badge badge-success' href=modification_logement.php?logid=".$list['lid'].">Modifier</a>"."<a class='film-suppr badge badge-danger' href=suppression_logement.php?logid=".$list['lid'].">Supprimer</a>"."</td></tr>";
...
span4.addEventListener('click', function(){
  span4.classList.toggle('fa-arrow-up');
})
