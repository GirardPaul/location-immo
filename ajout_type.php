...
echo "<h1 class='mt-10'>Ajouter un type de logement :</h1>";
echo "<input type='text' id='form1' placeholder='Type' class='form-control' name='type'><br>";



echo "<input type='submit' class='btn btn-dark btn-lg btn-block' id='btn-toast' value='Ajouter'>";
...
form.addEventListener('submit', function(event){
  ...
  toastr.success('Votre type de logement a bien été ajouté !');
  setTimeout(() => {
    form.submit();
  }, 2000);
...
if(isset($_POST['type'])){
    ...
    $ajout = "INSERT INTO type (nom) VALUES('$type')";
    $req = $bdd->query($ajout);
