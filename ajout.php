...
echo "<h1 class='mt-10 text-center'>Ajouter un client :</h1>";


echo "<input type='text' id='form1' placeholder='Nom' class='form-control' name='nom'><br>";
echo "<input type='text' id='form2' placeholder='Prénom' class='form-control' name='prenom'><br>";
echo "<input type='date' id='form3' placeholder='Date de naissance' class='form-control' name='date_naissance'><br>";
echo "<input type='tel' id='form4' placeholder='Téléphone' class='form-control' name='numero_tel'><br>";



echo "<input type='submit' class='btn btn-dark btn-lg btn-block w-100' id='btn-toast' value='Ajouter'>";
...
form.addEventListener('submit', function(event){
  ...
  toastr.success('Votre client a bien été ajouté !');
  setTimeout(() => {
    form.submit();
  }, 2000);
...
if(isset($_POST['nom']) AND isset($_POST['prenom']) AND isset($_POST['date_naissance']) AND isset($_POST['numero_tel'])){
    ...
    $ajout = "INSERT INTO client (nom, prenom, date_naissance, num_tel) VALUES('$nom', '$prenom', '$date_naissance', '$numero_tel')";
    $req = $bdd->query($ajout);
