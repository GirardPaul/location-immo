...
<?php
    ...
    $sql="SELECT * FROM client WHERE id=".$_GET['listid']."";
    $req = $bdd->query($sql);
...
while ($list=$req->fetch()){
	...
	echo "<input type='text' id='form1' class='mb-2 form-control ' name='nom' value='".$list['nom']."'>";
	echo "<input type='text' id='form1' class='mb-2 form-control ' name='prenom' value='".$list['prenom']."'>";
	echo "<input type='date' class='mb-2 form-control ' name='date_naissance' value='".$list['date_naissance']."'>";
    echo "<input type='tel' class='mb-2 form-control ' name='num_tel' value='".$list['num_tel']."'>";
   
  
}
echo "<input type='submit' class='btn btn-dark btn-lg btn-block w-100' value='Modifier'>";



if(isset($_POST['nom'])){
	
    $update="UPDATE client SET nom='".$_POST['nom']."', prenom='".$_POST['prenom']."', date_naissance='".$_POST['date_naissance']."', num_tel='".$_POST['num_tel']."' WHERE id=".$_GET['listid']."";
